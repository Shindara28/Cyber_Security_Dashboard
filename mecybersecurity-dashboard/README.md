...
- Create a minimal `package.json` with scripts and deps for React + Vite.
- Fill the `src` files with starter component code and wire up routes.
- Add example implementations for the utils (password generator, IP lookup mock, hash checker).
